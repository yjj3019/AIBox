...
# no proxy
export no_proxy="localhost, 127.0.0.1, 172.x.x.113"
...
export LLM_URL="http://172.x.x.113:4000" # 여기에 LLM 서버 URL을 입력하세요. 예: http://192.168.1.10:8080
...
export TOKEN="sk-xxxxxx"   # LLM 서버에 토큰이 필요하면 여기에 입력하세요. (선택 사항)
