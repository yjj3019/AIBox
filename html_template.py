...
def get_html_template(data):
    ...
    svg_icons = {
        ...
        "paging": '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="icon"><path d="M20 2H8c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm-8 12H9v-2h3v2zm4-4H9V8h7v2zm0-4H9V4h7v2zM4 6H2v14c0 1.1.9 2 2 2h14v-2H4V6z"></path></svg>',
    ...
    <body>
        <div class="container">
            ...
            <div class="report-card">
                ...
                <div class="card-body graph-grid">{render_graph('cpu', 'CPU Usage (%)', graphs)}{render_graph('memory', 'Memory Usage (KB)', graphs)}{render_graph('load', 'System Load Average', graphs)}{render_graph('paging', 'Paging Statistics (sar -B)', graphs)}{render_graph('io_usage', 'I/O Usage (sar -b)', graphs)}{render_graph('disk_detail', 'Block Device I/O (sar -d)', graphs)}{render_graph('swap', 'Swap Usage (%)', graphs)}{render_graph('file_handler', 'File and Inode Handlers', graphs)}{render_graph('network_representative', 'Network Traffic', graphs)}</div>
            </div>
